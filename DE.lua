...
ZO_CreateStringId("SI_LEDGER_SUMMARY1"              , "Kontostand änderte sich um <<1>> in |cC4C19B<<z:2>>|r.")
ZO_CreateStringId("SI_LEDGER_SUMMARY2"              , "Größte Ausgabe war |cC4C19B<<1>>|r (<<2>>) und größte Einnahme |cC4C19B<<3>>|r (<<4>>).")
